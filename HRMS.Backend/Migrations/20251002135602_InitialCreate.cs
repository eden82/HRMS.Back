        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    leave_credit = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoalProcess = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "roles",
                columns: new[] { "id", "description", "is_system", "name", "permissions", "TenantId" },
                values: new object[,]
                {
                    { new Guid("00000000-0000-0000-0000-000000000001"), "Full system access", true, "SuperAdmin", "[\"*\"]", null },
                    { new Guid("00000000-0000-0000-0000-000000000002"), "Tenant admin access", true, "SystemAdmin", "[\"Manage Setting\",\"AdminPage\",\"Employee Portal\"]", null },
                    { new Guid("00000000-0000-0000-0000-000000000003"), "Human resources access", true, "HR", "[\"Employee Management\",\"Department Management\",\"Attendance Management\",\"Leave Management\",\"Recruitment and ATS\",\"Performance Management\",\"Training and Development Management\",\"Announcement Management\",\"Employee Portal\"]", null },
                    { new Guid("00000000-0000-0000-0000-000000000004"), "Basic employee access", true, "Employee", "[\"Employee Portal\"]", null }
                });
